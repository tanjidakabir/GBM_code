...
if __name__ == '__main__':
	...
	print("Get files_lists and label_list.......*************", file_lists[2:3])

	print("Get files_lists and label_list.......*************", label_list[2:3])


	#data_np, label_np = get_data(file_lists[2:3], label_list[2:3])
	data_np, label_np = get_data(file_lists, label_list)
	print("DEBUG 2", data_np.shape, label_np.shape)
