...
#from dataset.memDataSet import BraTSValDataSet
...
def get_arguments():
    ...
    parser.add_argument("--data-dir", type=str, default='/home/testing_dataset/patients_paper_follow_up/older/pre_operative_with_seg_1/',
    ...
    parser.add_argument("--restore-from", type=str, default='snapshots/conresnet/ConResNet_5000.pth',
                        help="Where restore model parameters from.")
    parser.add_argument("--gpu", type=str, default='14',
...
def main():
    ...
    for index, batch in enumerate(testloader):
        ...
        print('Processing {}: Dice_ET = {:.4}, Dice_NCR_NET = {:.4}, Dice_ED = {:.4}'.format(name, dice_ET_i, dice_WT_i, dice_TC_i))
